...
folder_sub_files1 = '/simDyna256_Re100/spectraFiles/' # folder where data is located
folder_sub_files2 = '/simDyna256_Re50/spectraFiles/' # folder where data is located
## Specify which variables you want to plot
var_iter = 76 # which file iter should be plotted?
...
header_names_Re100, data_x_Re100, data_y_Re100 = loadData((folder_main + folder_sub_files1), 
        name_file_Re100, var_x_Re100, var_y_Re100, bool_disp_header)
...
header_names_Re50, data_x_Re50, data_y_Re50 = loadData((folder_main + folder_sub_files2), 
        name_file_Re50, var_x_Re50, var_y_Re50, bool_disp_header)
