...
##################################################################
global file_max, debug_mode, filepath_base
...
print('\tFolder 1: ' + folder_data_1)
print('\tFolder 2: ' + folder_data_2)
print('\tFolder 3: ' + folder_vis)
print(' ')
